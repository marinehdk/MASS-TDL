...
**扫视优先级（T1 产出）：** [TBD]
**注意：** 拖船操作特点（短距离高频机动）可能导致 scan_priority 与 FCB 显著不同。
...
[TBD — 1–3 条；须标注 vessel_type 差异（拖船短距离高频机动 vs FCB 近岸运营）对 §12.3 差异化视图的影响]
