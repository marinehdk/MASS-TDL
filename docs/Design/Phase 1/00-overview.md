...
| 进度日期 | 2026-05-20（D1.3.1' Simulator Qualification ✅ 已关闭）|
...
| D1.6 | 场景 schema + farn + 三层 CI 集 | （未建目录）| 🔴 stub 空壳（`docs/Design/SIL/02-scenario-schema.md`）|
...
| # | 风险 | 等级 |
|---|---|---|
| R1.A | 4 个 D 任务（D1.3.1 sim qual / D1.4 / D1.6 / D1.7）全 stub，DEMO-1 验收风险 | 🔴 高 |
